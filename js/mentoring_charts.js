/*
Script on this page is used to populate the charts at the top of mentoring.html that use the date filters
*/
...
function drawDashboard() {
		var query = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024');
		query.setQuery('SELECT A, B, C, D, E, F, E*F LABEL E*F "Volunteer Hours"');
