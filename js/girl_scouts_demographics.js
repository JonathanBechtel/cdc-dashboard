/*
This script is used to generate the tables and graphs on the page girl_scouts_demographics.html
*/
...
function drawDashboard() {
	...
	query.setQuery('SELECT * WHERE M !="Never"')
	query.send(function(response) {
		...
		query2.setQuery('SELECT X WHERE M !="Never"');
		...
		query3.setQuery('SELECT G WHERE M !="Never"');
		...
		query4.setQuery('SELECT W WHERE M !="Never"');
		...
		query5.setQuery('SELECT J WHERE M !="Never"');
		...
		query6.setQuery('SELECT T WHERE M !="Never"');
		...
		query7.setQuery('SELECT U WHERE M !="Never"');
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT Z WHERE M !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AG WHERE M !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AA WHERE M !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT V WHERE M !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
	...
	vQuery.setQuery('SELECT * WHERE H CONTAINS "Girl Scouts"');
