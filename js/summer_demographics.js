...
function drawDashboard() {
	...
	query.setQuery('SELECT * WHERE R !="Never"')
	query.send(function(response) {
		...
		query2.setQuery('SELECT X WHERE R !="Never"');
		...
		query3.setQuery('SELECT G WHERE R !="Never"');
		...
		query4.setQuery('SELECT W WHERE R !="Never"');
		...
		query5.setQuery('SELECT J WHERE R !="Never"');
		...
		query6.setQuery('SELECT T WHERE R !="Never"');
		...
		query7.setQuery('SELECT U WHERE R !="Never"');
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT Z WHERE R !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AG WHERE R !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AA WHERE R !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT V WHERE R !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
	...
	vQuery.setQuery('SELECT * WHERE H CONTAINS "Summer Lunch Program"');
