/*
Script on this page is used to populate the charts at the top of booster.html that use the date filters
*/
...
function drawDashboard() {
		var query = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=2137020956');
		query.setQuery('SELECT A, B, C, D, E, E*F LABEL E*F "Total Volunteer Hours"')
