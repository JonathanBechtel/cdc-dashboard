/*
This script is used to generate the tables and graphs on the page esl_demographics.html
*/
...
function drawDashboard() {
	...
	query.setQuery('SELECT * WHERE H !="Never"');
	query.send(function(response) {
		...
		query2.setQuery('SELECT X WHERE H !="Never"');
		...
		query3.setQuery('SELECT G WHERE H !="Never"');
		...
		query4.setQuery('SELECT W WHERE H !="Never"');
		...
		query5.setQuery('SELECT J WHERE H !="Never"');
		...
		query6.setQuery('SELECT T WHERE H !="Never"');
		...
		query7.setQuery('SELECT U WHERE H !="Never"');
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT Z WHERE H !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AG WHERE H !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT AA WHERE H !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
		...
		var query7 = new google.visualization.Query('https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1852373469');
		query7.setQuery('SELECT V WHERE H !="Never"');
		query7.send(function(response7) {
			var data7 = response7.getDataTable();
			var aggData6 = new google.visualization.data.group(
				data7,
	...
	vQuery.setQuery('SELECT * WHERE H CONTAINS "ESL"');
