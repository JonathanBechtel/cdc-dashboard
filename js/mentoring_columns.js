...
to the right of the charts w/ filters at the top of the page on mentoring.html*/
...
function drawTables() {
		...
		var colTable1 = new google.visualization.ChartWrapper({
			...
			'dataSourceUrl':   'https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024',
		...
		var colTable9 = new google.visualization.ChartWrapper({
			...
			'dataSourceUrl':   'https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024',
			'query'        :   'SELECT COUNT(D) WHERE DATEDIFF(now(), toDate(A)) < 31 LABEL COUNT(D) "This Month"'
		});
		colTable9.draw();
		...
		var colTable10 = new google.visualization.ChartWrapper({
			...
			'dataSourceUrl':   'https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024',
			'query'        :   'SELECT COUNT(D) WHERE DATEDIFF(now(), toDate(A)) > 30 AND DATEDIFF(now(), toDate(A)) < 60 LABEL COUNT(D) "Last Month"'
		});
		colTable10.draw();
		...
		var colTable11 = new google.visualization.ChartWrapper({
			...
			'dataSourceUrl':   'https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024',
			'query'        :   'SELECT COUNT(D) WHERE DATEDIFF(now(), toDate(A)) < 366 LABEL COUNT(D) "Year to Date"'
		});
		colTable11.draw();
		...
		var colTable12 = new google.visualization.ChartWrapper({
			...
			'dataSourceUrl':   'https://docs.google.com/spreadsheets/d/1lmmpJs2Bz3EfQWExB4KXq_uJWoLlq1PMCahy6w4ipcE/gviz/tq?gid=1402396024',
			'query'        :   'SELECT COUNT(D) LABEL COUNT(D) "All Time"'
		});
		colTable12.draw();
}
